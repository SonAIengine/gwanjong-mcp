...
def _seed_db(db_path: Path) -> None:
    ...
    try:
        ...
        conn.execute(
            ...
            ("devto", "https://dev.to/example/post", "comment", "hello", "MCP", "2026-03-13T00:00:00+00:00"),
        )
        conn.execute(
        ...
        conn.execute(
            ...
            ("c1", "devto", "https://dev.to/example/post", "alice", "reply", "2026-03-13T01:00:00+00:00", 0),
        )
        conn.execute(
            """
            ...
            """,
            (
                "MCP", "devto", "comment", "pending", "opp_0", "post_123",
                "https://dev.to/example/post", "Need feedback", "generated",
                "{}", "{}", "2026-03-13T02:00:00+00:00", None, None, None,
            ),
        )
        conn.execute(
            """
            ...
            """,
            (
                "MCP", "devto", "comment", "posted", "opp_1", "post_456",
                "https://dev.to/example/posted", "Posted item", "generated",
                "{}", "{}", "2026-03-13T02:30:00+00:00", "2026-03-13T03:00:00+00:00",
                "2026-03-13T03:00:00+00:00", None,
            ),
        )
        conn.execute(
            """
            ...
            """,
            (
                "MCP", "devto", "comment", "failed", "opp_2", "post_789",
                "https://dev.to/example/failed", "Failed item", "generated",
                "{}", "{}", "2026-03-13T04:00:00+00:00", "2026-03-13T04:10:00+00:00",
                "2026-03-13T04:10:00+00:00", "boom",
            ),
        )
        conn.commit()
    finally:
...
async def test_perform_approval_action_approve(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("gwanjong_mcp.dashboard.ApprovalQueue.execute_approved", fake_execute_approved)
